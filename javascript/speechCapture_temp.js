import { sendTranslationRequest } from './translationController_temp.js';
...
function executeSpeechRecognition() {
  ...
  function processText(text) {
    ...
    const chunkSizeMap = { "ja": 35, "zh-TW": 33, "es-ES": 80, "en-US": 80, "id-ID": 80 }; //1920*1080 字體24px的狀況下一行的大概數值
